# 첫번째 미션 - 소스코드 설치하기 
첫번째 미션에 오신것을 환영합니다.  
본격적으로 AI 미션을 시작하기 전에, 소스코드 설치 방법과 실행 방법을 익혀보겠습니다. 
...
- npm run dev 를 실행하여, 소스코드를 실행합니다. 
- 브라우저에서 http://localhost:5173/ 에 접속하여, 소스코드가 정상적으로 실행되는지 확인합니다.
  - 성공일 경우, "Vue Ai Just Play" 라는 텍스트가 보입니다.
